...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA KELOMPOK KEJAHATAN. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA KELOMPOK KEJAHATAN',
            draggable: true,
            buttons : [
              {
                label : 'YA',
...
function baru(){
	...
	$("#titleModal").html('TAMBAH DATA KELOMPOK KEJAHATAN ');
}
...
$("#titleModal").html('EDIT DATA KELOMPOK KEJAHATAN');
