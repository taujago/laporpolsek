...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA PENGADILAN. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA PENGADILAN',
            draggable: true,
            buttons : [
              {
                label : 'YA',
...
function baru(){
	...
	$("#titleModal").html('TAMBAH DATA PENGADILAN');
}
...
$("#titleModal").html('EDIT DATA PENGADILAN');
