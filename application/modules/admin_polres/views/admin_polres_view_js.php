...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA POLRES. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA POLRES',
            draggable: true,
            buttons : [
              {
                label : 'YA',
...
function baru(){
	...
	$("#titleModal").html('TAMBAH DATA POLRES');
}
...
$("#titleModal").html('EDIT DATA POLRES');
