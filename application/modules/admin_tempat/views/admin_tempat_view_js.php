...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA KATEGORI TEMPAT KEJAHATAN. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA KATEGORI TEMPAT KEJAHATAN',
            draggable: true,
            buttons : [
              {
                label : 'YA',
...
function baru(){
	...
	$("#titleModal").html('TAMBAH DATA KATEGORI TEMPAT KEJAHATAN ');
}
...
$("#titleModal").html('EDIT DATA KATEGORI TEMPAT KEJAHATAN');

	$.ajax({
		url : '<?php echo site_url("$controller/get_json_detail") ?>/'+id, 
		dataType : 'json',
		success : function(obj) {
			$("#id_jenis_lokasi").val(obj.id_jenis_lokasi);
			$("#jenis_lokasi").val(obj.jenis_lokasi);
