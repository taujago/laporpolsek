<?php
class admindik_laka extends admindik_controller {
 	var $controller ;

	function admindik_laka(){
		parent::__construct();
...
function penyidik_hapus(){
    ...
    $this->cm->set_unsync2("lap_laka_lantas","lap_laka_lantas_id","lap_laka_penyidik","id",$data['id']);
