...
<a target="blank" class="btn btn-success" href="<?php echo site_url("$controller/cetak_rekomendasi/$lap_a_id") ?>"><span class="glyphicon glyphicon-print"></span></i> Cetak Rekomendasi Penilaian Laporan  Polisi </a>
<hr /> 
<br />
