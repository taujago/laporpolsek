...
<table width="100%" border="0" cellpadding="0">
  <tr>
    <td width="20%">NAMA</td>
    <td width="80%">: <?php echo $pen_lapor_nama; ?></td>
  </tr>
  <tr>
    <td>TMPT / TGL. LAHIR</td>
    <td>: <?php echo $pelapor_tmp_lahir.', '.$pelapor_tgl_lahir; ?></td>
  </tr>
  <tr>
    <td>JENIS KELAMIN</td>
    <td>: <?php 
  ...
  <tr>
    <td>ALAMAT</td>
    <td>: <?php echo $pelapor_alamat.', Desa/Kel. '.$desa.', Kec. '.$kecamatan.', Kabupaten/Kota. '.$kota.', Provinsi '.$provinsi ?></td>
  </tr>
  <tr>
    <td>TEL/FAX/EMAIL</td>
    <td>:</td>
...
<p>Sehubungan dengan laporan polisi <?php echo $nomor  ?> tanggal <?php echo tgl_indo(flipdate($tanggal));  ?> tentang </p>
