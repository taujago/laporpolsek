...
<div class="row" style="margin-bottom:20px;">
    ...
    <div class="col-md-6">
        <div class="input-group">
            <input id="txt_cari" type="text" Placeholder="Cari nama" class="form-control"   />
    ...
    <div class="col-md-2">
        ...
        <a href="<?php echo site_url("$controller/baru"); ?>" class="btn btn-success"><span class="glyphicon glyphicon-add"></span>Tambah Baru </a>
    </div>
</div>
