...
<table width="100%" border="0" cellpadding="0">
  <tr>
    <td width="61%">NOMOR : <?php echo $nomor; ?></td>
    <td width="39%">TANGGAL : <?php echo tgl_indo(flipdate($tanggal)); ?></td>
  </tr>
  <tr>
    <td colspan="2"><?php echo $tindak_pidana; ?> Terlapor : <?php echo $terlapor; ?></td>
  </tr>
</table>
<table width="100%" border="0" cellpadding="0">
  <tr>
