<?php
class penyidik_lap_b_model extends CI_Model {
	function penyidik_lap_b_model(){
		parent::__construct();
	}
...
function data($param){
	...
	$this->db->select('a.*')->from('v_lap_b a'); 
	$this->db->join("lap_b_penyidik b","a.lap_b_id = b.lap_b_id","left");
