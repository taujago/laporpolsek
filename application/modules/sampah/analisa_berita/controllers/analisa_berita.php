<?php
class analisa_berita extends master_controller {
	...
	function analisa_berita(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("analisa_berita_model","dm");
		$this->controller = get_class($this);
		$this->title = "ANALISA BERITA";
		$this->table_name = "analisa_berita";
...
function simpan(){
		...
		$this->form_validation->set_rules('topik_utama','Topik utama','required');	
