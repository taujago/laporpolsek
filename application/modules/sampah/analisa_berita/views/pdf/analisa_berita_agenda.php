...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td width="50%" align="right">R.IN.14</td>
  </tr>
</table><br />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" align="center"><p align="center"><strong>DATA ANALISA BERITA</strong></p></td>
  </tr>
  <tr>
...
<table width="100%"  cellspacing="0" cellpadding="7" class="cetak">
  <tr>
    ...
    <th width="43%" align="center" scope="col"><strong>JUDUL</strong></th>
    <th width="23%" align="center" scope="col"><strong>NARA SUMBER</strong></th>
  ...
  <tr>
    ...
    <th width="43%" align="center" bgcolor="#999999" scope="col">3</th>
  ...
  ?>
  <tr>
    <td width="7%" align="center" scope="col"><?php echo $n; ?></td>
    <td width="10%" scope="col"><?php echo flipdate($row->tanggal); ?></td>
    <td width="43%" scope="col"><?php echo $row->judul; ?></td>
    <td width="23%" scope="col" align="justify"><?php echo str_replace("#",",",$row->nara_sumber); ?></td>
