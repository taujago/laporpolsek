<?php
class analisa_sasaran extends master_controller {
	...
	function analisa_sasaran(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("analisa_sasaran_model","dm");
		$this->controller = get_class($this);
		$this->title = "ANALISA SASARAN";
		$this->table_name = "analisa_sasaran";
