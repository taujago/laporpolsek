<?php
class analisa_tugas extends master_controller {
	...
	function analisa_tugas(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("analisa_tugas_model","dm");
		$this->controller = get_class($this);
		$this->title = "ANALISA TUGAS";
		$this->table_name = "analisa_tugas";
...
function simpan(){
		...
		$this->form_validation->set_rules('identifikasi','Identifiaksi tugas','required');	
		$this->form_validation->set_rules('uraian','Pelaksana Tugas','required');	
...
function cetak_agenda($id){
		...
		$this->db->select('*')->from("$this->table_name a")
	 	...
	 	->join("pangkat c",'b.pangkat_id = c.pangkat_id');
