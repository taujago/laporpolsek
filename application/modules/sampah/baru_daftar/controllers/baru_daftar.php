...
function get_atpm(){
	...
	$data_service = array("LoginInfo"=>array(
			...
			$ret_service = $this->execute_service2($url,"ComplGetDataAtpmSub",$json_data);
			...
			if(!$ret_service){
				...
				if($ret_service['Result'] <> 1) {
					...
					$ran_data['no_mesin'] = $Data->NoMesin;
					// $ran_data['no_bpkb'] = $Data->NoBPKB;
					// $ran_data['tgl_bpkb'] = $Data->TglBPKB;
					// $ran_data['no_polisi'] = $Data->NoPolisi;
					// $ran_data['tahun_kendaraan'] = $Data->ThnBuat;
					// $ran_data['jenis_nama'] = $Data->Jenis;
					// $ran_data['merk_nama'] = $Data->Merk;
					// $ran_data['warna_nama'] = $Data->Warna;
					// $ran_data['nama_pemilik'] = $Data->NamaPemilik;
