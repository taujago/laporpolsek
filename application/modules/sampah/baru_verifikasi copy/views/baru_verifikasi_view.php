...
?>	
<tr>
    <td><input class="ck_data" type="checkbox" name="daft_id[]" value="<?php echo $row['daft_id']; ?>" /></td>
     ...
     <ul class="dropdown-menu">
		<li><a   href="<?php echo site_url("$controller/detail/".$row['daft_id']); ?>" onclick=""><span class="glyphicon glyphicon-chevron-right"></span> Detail </a></li>
		
        <li><a target="_blank" href="<?php echo site_url("$controller/cetak_permohonan/".$row['daft_id']); ?>" onclick=""><span class="glyphicon glyphicon-print"></span> Cetak Surat Permohonan</a></li>
        
        <li><a target="_blank" href="<?php echo site_url("$controller/cetak_berkas/".$row['daft_id']); ?>" onclick=""><span class="glyphicon glyphicon-print"></span> Cetak Surat Blokir</a></li>
	</ul>
	</div> 
...
<?php $this->load->view("baru_verifikasi_view_js") ?>
