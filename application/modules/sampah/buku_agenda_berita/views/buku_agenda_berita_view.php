...
<div class="row" style="margin-bottom:20px;">
    ...
    <div class="col-md-4">
        ...
        <a href="<?php echo site_url("$controller/baru/$this->jenis"); ?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Tambah Baru </a>
...
<thead>
	<tr style="background-color:#CCC">
        ...
        <th width="18%">TGL. / NOMOR BERITA</th>
        <th width="18%">DARI </th>
        <th width="18%">KEPADA</th>
        <th width="14%">JAM / TGL BERITA</th>
