<?php
class buku_kerja_intelijen extends master_controller {
	...
	function buku_kerja_intelijen(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("bki_model","dm");
		$this->controller = get_class($this);
		$this->title = "BUKU KERJA INTELIJEN";
		$this->table_name = "buku_kerja_intelijen";
