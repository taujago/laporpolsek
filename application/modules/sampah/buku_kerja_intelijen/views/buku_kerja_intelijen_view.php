...
<thead>
	<tr style="background-color:#CCC">
	  <th width="7%">NO.</th>
        ...
        <th width="26%">SUMBER / BAPUL </th>
        <th width="24%">NILAI DATA / INFORMASI</th>
        <th width="24%">URAIAN</th>
        <th width="15%">RUBRIK</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          ...
          <div class="form-group">
            <label for="message-text" class="control-label">RUBRIK:</label>
            	<?php 
					$arr = $this->jenis;
