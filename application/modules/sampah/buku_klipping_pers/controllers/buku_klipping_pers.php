<?php
class buku_klipping_pers extends master_controller {
	...
	function buku_klipping_pers(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("bkp_model","dm");
		$this->controller = get_class($this);
		$this->title = "LEMBAR KLIPPING PERS";
		$this->table_name = "buku_klipping_pers";
...
function simpan(){
		...
		$this->form_validation->set_rules('sumber','Sumber Penerbitan','required');	
