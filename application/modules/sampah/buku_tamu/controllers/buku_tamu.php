<?php
class buku_tamu extends master_controller {
	...
	function buku_tamu(){
		...
		$this->load->model("buku_tamu_model","dm");
		$this->controller = get_class($this);
		$this->title = "BUKU TAMU PPH & PPM";
		$this->table_name = "buku_tamu";
...
function simpan(){
		...
		$this->form_validation->set_rules('informasi','Informasi yang disampaikan','required');	
