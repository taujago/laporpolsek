<?php
class pengamanan extends master_controller {
	...
	function pengamanan(){
		...
		$this->load->model("pengamanan_model","dm");
	...
	function index(){
		...
		$this->set_subtitle("DATA PENGAMANAN");
		$this->set_title("DATA PENGAMANAN");
...
function baru(){
		...
		$data = array(
			"dasar_point_3"=>"",
			"dasar_point_7"=>"",
			"pertimbangan_point_a" =>"",
			"penyelidikan_id"=>"","penyelidikan_tentang"=>"",
		...
		$this->set_subtitle("INPUT DATA PENGAMANAN");
		$this->set_title("PENGAMANAN");
		$this->set_content($content);
		$this->render_baru();
...
function simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['penyelidikan_id']);
			 $res = $this->db->insert("pengamanan",$data);
...
function edit($id){
		...
		$this->set_subtitle("EDIT DATA PENGAMANAN");
		$this->set_title("EDIT DATA PENGAMANAN");
		$this->set_content($content);
		$this->render_baru();
	}
		...
		if($this->form_validation->run() == TRUE ) { 
 		...
 		$data['penyelidikan_waktu_pelaporan'] = flipdate($data['penyelidikan_waktu_pelaporan']);
			...
			$this->db->where("penyelidikan_id",$data['penyelidikan_id']);
			 $res = $this->db->update("pengamanan",$data);
			 if($res) {
...
$data['controller'] = $this->controller;
		...
		$this->set_subtitle("DETAIL DATA PENGAMANAN");
		$this->set_title("DETAIL DATA PENGAMANAN");
		$this->set_content($content);
		$this->render_baru();
...
function rencana($id){
		...
		$this->set_subtitle("DATA RENCANA PENGAMANAN : ". $data['penyelidikan_nomor']);
		$this->set_title("DATA RENCANA PENGAMANAN : ". $data['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
}
...
function rencana_baru($id){
		...
		$this->set_subtitle("INPUT DATA RENCANA PENGAMANAN ". $datax['penyelidikan_nomor']);
		$this->set_title("INPUT DATA RENCANA PENGAMANAN ". $datax['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
...
function rencana_simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			unset($data['mode']);
			unset($data['id']);
			 $res = $this->db->insert("pengamanan_rencana",$data);
			 // echo $this->db->last_query(); exit;
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"data berhasil disimpan");
			 }
...
function rencana_edit($id){
		...
		$data['controller'] = $this->controller;
		$content = $this->load->view("rencana/".$this->controller."_rencana_view_form",$data,true);
		$this->set_subtitle("EDIT DATA RENCANA PENGAMANAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_title("EDIT DATA RENCANA PENGAMANAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
	}
		...
		if($this->form_validation->run() == TRUE ) { 
 		...
 		// $data['waktu'] = flipdate($data['waktu']);
			...
			$this->db->where("id",$data['id']);
			 $res = $this->db->update("pengamanan_rencana",$data);
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"Data berhasil diupdate");
			 }
			 else {
...
function pelaksana($id){
		...
		$this->set_subtitle("DATA PELAKSANA PENGAMANAN : ". $data['penyelidikan_nomor']);
		$this->set_title("DATA PELAKSANA PENGAMANAN : ". $data['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
}
...
function pelaksana_baru($id){
		...
		$this->set_subtitle("INPUT DATA PELAKSANA PENGAMANAN ". $datax['penyelidikan_nomor']);
		$this->set_title("INPUT DATA PELAKSANA PENGAMANAN ". $datax['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
...
function pelaksana_simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			unset($data['mode']);
			unset($data['id']);
			 $res = $this->db->insert("pengamanan_pelaksana",$data);
			 // echo $this->db->last_query(); exit;
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"data berhasil disimpan");
			 }
...
function pelaksana_edit($id){
		...
		$data['controller'] = $this->controller;
		$content = $this->load->view("pelaksana/".$this->controller."_pelaksana_view_form",$data,true);
		$this->set_subtitle("EDIT DATA PELAKSANA PENGAMANAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_title("EDIT DATA PELAKSANA PENGAMANAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
	}
...
function pelaksana_update(){
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['mode']);			 
			$this->db->where("id",$data['id']);
			 $res = $this->db->update("pengamanan_pelaksana",$data);
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"Data berhasil diupdate");
			 }
			 else {
...
function pelaksana_hapus(){
	$data = $this->input->post();
	$this->db->where("id",$data['id']);
	$res = $this->db->delete("pengamanan_rencana");
	if($res){
		$ret = array("error"=>false,"message"=>"Data Berhasi dihapus");
...
function cetak_surat_perintah($id){
	 	...
	 	$data = $this->db->get("pengamanan")->row_array();


	 	$this->db->select('*')->from('pengamanan_pelaksana a')
		...
		$data['i'] = $i;
		$pdf->AddPage('P');
		$html = $this->load->view("pdf/pengamanan_surat_tugas",$data,true);		 
...
function cetak_rencana($id){
	 	...
	 	$this->db->select('*')->from('pengamanan_rencana');		
		$this->db->order_by("no_urut");
...
$pdf->SetMargins(10, 30, 10);
		...
		$pdf->AddPage('L');
		$html = $this->load->view("pdf/pengamanan_rencana",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/pengamanan_rencana_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 if( $halaman <> $pdf->getPage() ) {
		 	...
		 	$pdf->AddPage('L');
		 	$html = $this->load->view("pdf/pengamanan_rencana_head",$data,true);
		 	$pdf->writeHTML($html, true, false, true, false, '');
...
function cetak_agenda($id){
		...
		$pdf->AddPage('L');
		$html = $this->load->view("pdf/pengamanan_agenda",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/pengamanan_agenda_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 if( $halaman <> $pdf->getPage() ) {
		 	...
		 	$pdf->AddPage('L');
		 	// $html = $this->load->view("pdf/pengamanan_agenda_head",$data,true);
		 	// $pdf->writeHTML($html, true, false, true, false, '');
		...
		$pdf->Output('Surat Agenda Pengamanan .pdf', 'I');
