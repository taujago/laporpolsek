...
<table width="100%" border="0" cellspacing="1" cellpadding="1">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="2%">1.</td>
    <td width="84%"><p align="justify">Melakukan pengamanan atas pengumpulan informasi bahan/ data keterangan (puldata / pulbaket) secara terbuka dan/atau tertutup (surveylance) terhadap kegiatan tersebut di atas;</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>2.</td>
    <td><p align="justify">Melakukan pengamanan terhadap kegiatan wawancara, interogasi, pemeriksaan ataupun teknik intelijen lainnya dalam mencari informasi kepada pihak-pihak yang berkaitan dengan adanya informasi tersebut;</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>5.</td>
    <td><p align="justify">Melaksanakan Surat Perintah Operasi Intelijen (Pengamanan) ini dalam waktu 30 (tiga puluh) hari kerja sejak tanggal dikeluarkan;</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>6.</td>
    <td><p align="justify">Melaporkan hasil pelaksanaannya dalam tenggang waktu 7 (tujuh) hari kerja setelah Surat Perintah Operasi Intelijen (Pengamanan) selesai dilaksanakan.</p></td>
  </tr>
</table>
<p>&nbsp;</p>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="1%">:</td>
    <td width="53%">Yang bersangkutan </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="58%">&nbsp;</td>
    <td width="42%" align="center"><strong>KEPALA KEJAKSAAN NEGERI MAKASSAR</strong></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="center">&nbsp;</td>
