...
<div class="row">
	<div class="col-md-5 center-block">
                      ...
                      <div class="panel-heading">
                        <h3 class="panel-title">PELAKSANA & RENCANA PENGGALANGAN</h3>
                      </div>
                      <div class="panel-body">
                    <div class="btn-group btn-group-justified" 
                    role="group" aria-label="...">
  <div class="btn-group" role="group">
    <a  class="btn btn-primary" href="<?php echo site_url("$controller/rencana/$penyelidikan_id"); ?>"><span class="glyphicon glyphicon-list"></span>  Rencana Penggalangan</a>
  </div>
  <div class="btn-group" role="group">
    <a class="btn btn-primary" href="<?php echo site_url("$controller/pelaksana/$penyelidikan_id"); ?>"><span class="glyphicon glyphicon-user"></span>  Pelaksana Penggalangan</a>
  </div>  
</div>
    ...
    <div class="col-md-6 center-block">
                    ...
                    role="group" aria-label="...">
  <div class="btn-group" role="group">
    <a target="_blank" class="btn btn-success" href="<?php echo site_url("$controller/cetak_rencana/$penyelidikan_id"); ?>"><span class="glyphicon glyphicon-print"></span> Cetak Rencana Penggalangan</a>
  </div>
  <div class="btn-group" role="group">
  ...
  <div class='row'>
    ...
    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h3 class="panel-title">DETAIL DATA PENGAMANAN</h3>
                      </div>
                      <div class="panel-body">    
