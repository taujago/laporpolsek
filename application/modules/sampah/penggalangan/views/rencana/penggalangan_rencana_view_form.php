...
<table width="100%" border="0" class="table">
 ...
 <tr>
            <td>Sasaran Penggalangan</td>
            <td ><input type="text" class="form-control" name="pokok_masalah" id="pokok_masalah" placeholder="Sasaran Penggalangan" value="<?php echo $pokok_masalah; ?>" />
        </td>
	    <tr>
            <td>Indikasi Informasi Sasaran Penggalangan</td>
            <td><input type="text" class="form-control" name="indikasi" id="indikasi" placeholder="Indikasi Informasi Sasaran Penggalangan" value="<?php echo $indikasi; ?>" />
        </td>
	    <tr>
