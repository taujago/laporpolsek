<?php
class penyelidikan extends master_controller {

	var $controller ;

	function penyelidikan(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("penyelidikan_model","dm");
	...
	function index(){
		...
		$this->set_subtitle("DATA PENYELIDIKAN");
		$this->set_title("DATA PENYELIDIKAN");
...
function baru(){
		...
		$this->set_subtitle("INPUT DATA PENYELIDIKAN");
		$this->set_title("PENYELIDIKAN");
		$this->set_content($content);
		$this->render_baru();
...
function simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['penyelidikan_id']);
			 $res = $this->db->insert("penyelidikan",$data);
...
function edit($id){
		...
		$this->set_subtitle("EDIT DATA PENYELIDIKAN");
		$this->set_title("EDIT DATA PENYELIDIKAN");
		$this->set_content($content);
		$this->render_baru();
	}
		...
		if($this->form_validation->run() == TRUE ) { 
 		...
 		$data['penyelidikan_waktu_pelaporan'] = flipdate($data['penyelidikan_waktu_pelaporan']);
			...
			$this->db->where("penyelidikan_id",$data['penyelidikan_id']);
			 $res = $this->db->update("penyelidikan",$data);
			 if($res) {
...
function hapus(){
	...
	$res = $this->db->delete("penyelidikan");
	if($res){
...
$data['controller'] = $this->controller;
		...
		$this->set_subtitle("DETAIL DATA PENYELIDIKAN");
		$this->set_title("DETAIL DATA PENYELIDIKAN");
		$this->set_content($content);
		$this->render_baru();
...
function rencana($id){
		...
		$this->set_subtitle("DATA RENCANA PENYELIDIKAN : ". $data['penyelidikan_nomor']);
		$this->set_title("DATA RENCANA PENYELIDIKAN : ". $data['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
}
...
function rencana_baru($id){
		...
		$this->set_subtitle("INPUT DATA RENCANA PENYELIDIKAN ". $datax['penyelidikan_nomor']);
		$this->set_title("INPUT DATA RENCANA PENYELIDIKAN ". $datax['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
...
function rencana_edit($id){
		...
		$data['controller'] = $this->controller;
		$content = $this->load->view("rencana/".$this->controller."_rencana_view_form",$data,true);
		$this->set_subtitle("EDIT DATA RENCANA PENYELIDIKAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_title("EDIT DATA RENCANA PENYELIDIKAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
	}
...
function pelaksana($id){
		...
		$this->set_subtitle("DATA PELAKSANA PENYELIDIKAN : ". $data['penyelidikan_nomor']);
		$this->set_title("DATA PELAKSANA PENYELIDIKAN : ". $data['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
}
...
function pelaksana_baru($id){
		...
		$this->set_subtitle("INPUT DATA PELAKSANA PENYELIDIKAN ". $datax['penyelidikan_nomor']);
		$this->set_title("INPUT DATA PELAKSANA PENYELIDIKAN ". $datax['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
...
function pelaksana_simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			unset($data['mode']);
			unset($data['id']);
			 $res = $this->db->insert("penyelidikan_pelaksana",$data);
			 // echo $this->db->last_query(); exit;
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"data berhasil disimpan");
			 }
...
function pelaksana_edit($id){
		...
		$data['controller'] = $this->controller;
		$content = $this->load->view("pelaksana/".$this->controller."_pelaksana_view_form",$data,true);
		$this->set_subtitle("EDIT DATA PELAKSANA PENYELIDIKAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_title("EDIT DATA PELAKSANA PENYELIDIKAN ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
	}
...
function pelaksana_update(){
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['mode']);			 
			$this->db->where("id",$data['id']);
			 $res = $this->db->update("penyelidikan_pelaksana",$data);
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"Data berhasil diupdate");
			 }
			 else {
...
function cetak_agenda($id){
		...
		$bulan = $this->uri->segment(4); 
	 	...
	 	$res = $this->db->get("v_penyelidikan");
		...
		$pdf->AddPage('L');
		$html = $this->load->view("pdf/penyelidikan_agenda",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/penyelidikan_agenda_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
