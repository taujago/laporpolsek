...
<thead>
	<tr style="background-color:#CCC">
	  <th width="3%">NO.</th>
        ...
        <th width="14%">POKOK MASALAH</th>
        <th width="11%">INDIKASI</th>
        <th width="18%">INFO YANG DIPERLUKAN</th>
        <th width="12%">BADAN PENGUMPUL</th>
        <th width="12%">SUMBER INFORMASI</th>
        <th width="9%">WAKTU DAN TEMPAT</th>
