		 ...
		 var dt = $("#leasing").DataTable(
		 	{
				...
				"processing": true,
		        "serverSide": true,
		        "ajax": '<?php echo site_url("$controller/rencana_get_data/$penyelidikan_id") ?>'
		 	});
...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA RENCANA  PENYELIDIKAN. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA  RENCANA PENYELIDIKAN',
            draggable: true,
            buttons : [
              {
                label : 'YA',
