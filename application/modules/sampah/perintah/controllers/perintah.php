<?php
class perintah  extends master_controller {
	...
	function perintah (){
		...
		$this->load->model("perintah_model","dm");
...
function simpan(){
		...
		$data['laporan_tanggal'] = flipdate($data['laporan_tanggal']);
		...
		if($this->form_validation->run() == TRUE ) { 
			...
			unset($data['penyelidikan_id']);
			 $res = $this->db->insert("perintah",$data);
...
function edit($id){
		...
		$this->set_subtitle("EDIT DATA SURAT PERINTAH");
		$this->set_title("EDIT DATA SURAT PERINTAH");
		$this->set_content($content);
		$this->render_baru();
	}
		...
		if($this->form_validation->run() == TRUE ) { 
 		...
 		$data['laporan_tanggal'] = flipdate($data['laporan_tanggal']);
			...
			$this->db->where("penyelidikan_id",$data['penyelidikan_id']);
			 $res = $this->db->update("perintah",$data);
			 if($res) {
...
$data['controller'] = $this->controller;
		...
		$this->set_subtitle("DETAIL DATA SURAT PERINTAH");
		$this->set_title("DETAIL DATA SURAT PERINTAH");
		$this->set_content($content);
		$this->render_baru();
...
function pelaksana($id){
		...
		$this->set_subtitle("DATA PELAKSANA SURAT PERINTAH : ". $data['penyelidikan_nomor']);
		$this->set_title("DATA PELAKSANA SURAT PERINTAH : ". $data['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
}
...
function pelaksana_baru($id){
		...
		$this->set_subtitle("INPUT DATA PELAKSANA SURAT PERINTAH ". $datax['penyelidikan_nomor']);
		$this->set_title("INPUT DATA PELAKSANA SURAT PERINTAH ". $datax['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
...
function pelaksana_simpan(){
		...
		if($this->form_validation->run() == TRUE ) { 
			unset($data['mode']);
			unset($data['id']);
			 $res = $this->db->insert("perintah_pelaksana",$data);
			 // echo $this->db->last_query(); exit;
			 if($res) {
			 	$ret = array("error"=>false,"message"=>"data berhasil disimpan");
			 }
...
function pelaksana_edit($id){
		...
		$data['controller'] = $this->controller;
		$content = $this->load->view("pelaksana/".$this->controller."_pelaksana_view_form",$data,true);
		$this->set_subtitle("EDIT DATA PELAKSANA SURAT PERINTAH ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_title("EDIT DATA PELAKSANA SURAT PERINTAH ". $data_penyelidikan['penyelidikan_nomor']);
		$this->set_content($content);
		$this->render_baru();
	}
...
function cetak_surat_perintah($id){
	 	...
	 	$data = $this->db->get("perintah")->row_array();
		...
		$data['i'] = $i;
		$pdf->AddPage('P');
		$html = $this->load->view("pdf/perintah_surat_tugas",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/perintah_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
...
function cetak_agenda($id){
		...
		$pdf->AddPage('L');
		$html = $this->load->view("pdf/perintah_agenda",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/perintah_agenda_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
