...
<div class="row">
  ...
  <div class="btn-group" role="group">
    <a class="btn btn-primary" href="<?php echo site_url("$controller/pelaksana/$penyelidikan_id"); ?>"><span class="glyphicon glyphicon-user"></span>  Pelaksana Perintah</a>
  </div>  
</div>
  ...
  <div class='row'>
    ...
    <div class="panel panel-default">
	    ...
	    <tr>
	      <td>Nomor Laporan Harian</td>
	      <td><?php echo $laporan_nomor; ?></td>
	      </tr>
	    <tr>
	      <td>Tanggal Laporan Harian </td>
	      <td><?php echo flipdate($laporan_tanggal); ?></td>
	      </tr>
	    </table>
