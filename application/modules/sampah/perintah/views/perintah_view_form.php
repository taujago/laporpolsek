...
<table width="100%" border="0" class="table">
 <tr>
    ...
    <tr>
      <td align="left" valign="middle">No. Laporan Informasi Harian</td>
      <td align="left"><input type="text" class="form-control" name="laporan_nomor" id="laporan_nomor" placeholder="Nomor Laporan Informasi Harian" value="<?php echo $laporan_nomor; ?>"    /></td>
    </tr>
    <tr>
      <td align="left" valign="middle">Tgl. Laporan Informasi Harian</td>
      <td align="left"><input type="text" class="form-control tanggal" name="laporan_tanggal" id="laporan_tanggal" placeholder="Tanggal Laporan Informasi Harian" value="<?php echo $laporan_tanggal; ?>"  data-date-format="dd-mm-yyyy"   /></td>
    </tr>
    <tr>
