<?php
class surat_permintaan_keterangan extends master_controller {
	...
	function surat_permintaan_keterangan(){
		parent::__construct();
		// $this->load->model("core_model","cm");
		$this->load->model("coremodel","cm");
		$this->load->helper("tanggal");
		$this->load->model("spk_model","dm");
		$this->controller = get_class($this);
		$this->title = "SURAT PERMINTAAN KETERANGAN";
		$this->table_name = "surat_permintaan_keterangan";
		// $this->jenis = array("budaya"=>"BUDAYA",
		// 					 "ekonomi"=>"EKONOMI",
		// 					 "hankam"=>"PERTAHANAN DAN KEAMANAN (HANKAM)",
		// 					 "ideologi" => "IDEOLOGI",
		// 					 "keuangan" =>"KEUANGAN",
		// 					 "politik"=>"POLITIK",
		// 					 "sosial" => "SOSIAL");
...
$id = $row['id'];
        	...
        	$arr_data[] = array(
        		  				...
        		  				$row['nomor'] ,   
        		  				$row['kepada'] ,  		
        		  				flipdate($row['isi_tanggal']),				 
         		  				str_replace("#", " ,", $row['bertemu_dengan']), 
...
"id" => "");
		...
		$this->set_subtitle("INPUT DATA  $this->title");
		$this->set_title(" BUKU $this->title");
		$this->set_content($content);
		$this->render_baru();
...
function simpan(){
		...
		$this->form_validation->set_rules('kepada','Tujuan Surat','required');	
		...
		$this->form_validation->set_message('required', ' %s Harus diisi ');
 		...
 		$data['isi_tanggal'] = flipdate($data['isi_tanggal']);
...
function edit($id){
		...
		$this->set_subtitle("EDIT DATA $this->title");
		$this->set_title("EDIT DATA $this->title");
		$this->set_content($content);
		$this->render_baru();
	}
...
function cetak_agenda($id){
		...
		$this->db->select('*')->from("$this->table_name a");
		...
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/".$this->controller."_agenda_ttd",$data,true);
		 $pdf->writeHTML($html, true, false, true, false, '');
		...
		$pdf->Output("Buku $this->title.pdf", 'I');
...
function cetak_surat($id){
		...
		$pdf->AddPage('P');
		$html = $this->load->view("pdf/$this->table_name"."_surat",$data,true);		 
		$pdf->writeHTML($html, true, false, true, false, '');
		 ...
		 $html = $this->load->view("pdf/$this->table_name"."_surat_ttd",$data,true);		 
		 $pdf->writeHTML($html, true, false, true, false, '');
...
*/
		...
		$pdf->Output('analisa berita.pdf', 'I');
