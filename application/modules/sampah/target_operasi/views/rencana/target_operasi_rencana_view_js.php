		 ...
		 var dt = $("#leasing").DataTable(
		 	{
				...
				"processing": true,
		        "serverSide": true,
		        "ajax": '<?php echo site_url("$controller/rencana_get_data/$to_id") ?>'
		 	});
...
BootstrapDialog.show({
            message : 'ANDA AKAN MENGHAPUS DATA RENCANA  TARGET OPERASI. ANDA YAKIN  ?  ',
            title: 'KONFIRMASI HAPUS DATA  RENCANA TARGET OPERASI',
            draggable: true,
            buttons : [
              {
                label : 'YA',
