   ...
   <!-- <div class="navbar-header">
    ...
    <div>
      <ul class="nav navbar-nav">
        <li><a href="<?php echo site_url("verifikatur"); ?>">DEPAN</a></li>
        <li><a href="<?php echo site_url("polisi_verifikasi"); ?>">VERIFIKASI</a></li>
      <li><a href="<?php echo site_url("polisi_blokir_pidana"); ?>">BLOKIR PIDANA</a></li>
